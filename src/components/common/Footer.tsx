...
export default function Footer() {
  return (
    <div className="lg:px-[10%] px-[5%] text-white py-[2%] border-t border-white flex lg:flex-row flex-col justify-between lg:items-center border-opacity-10 lg:gap-0 gap-6">
